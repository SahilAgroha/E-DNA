...
import SampleCardsGrid from './SampleCardsGrid'; // Import new component
import SampleDetailModal from './SampleDetailModal'; // Import new component
...
const Abundance = () => {
    ...
    const [modalSampleId, setModalSampleId] = useState(null); // State for modal data
    ...
    const renderAbundanceCharts = () => {
        ...
        return (
            <div className="mt-8">
                ...
                {/* Sample Summary Grid */}
                <SampleCardsGrid 
                    sampleSummaryData={currentAnalysis.abundance_data.summary}
